 ...
 */
const instructorGeo = new GeospatialIndex<
  Id<"users">,
  { 
 ...
 */
const jobGeo = new GeospatialIndex<
  Id<"jobs">,
  {
    category: string;
    status: string;
...
const findInstructorsForJobQuery = internalQuery({
  args: {
...
const getNearbyJobsForInstructor = query({
  args: {
    latitude: v.string(),
    longitude: v.string(),
    radiusKm: v.string(),
 ...
 */
async function syncInstructorLocation(
  ctx: MutationCtx,
 ...
 */
async function removeInstructorLocation(
  ctx: MutationCtx,
  instructorId: Id<"users">
): Promise<void> {
  try { 
 ...
 */
async function syncJobLocation(
  ctx: MutationCtx,
  jobId: Id<"jobs">,
  point: Point,
  category: string,
 ...
 */
async function removeJobLocation(
  ctx: MutationCtx,
  jobId: Id<"jobs">
): Promise<void> {
  try { await jobGeo.remove(ctx, jobId); } catch {}
 ...
 */
async function findInstructorsForJob(
  ctx: QueryCtx,
  jobPoint: Point,
  jobCategory: string,
  requiresVerification: boolean,
 ...
 */
async function findJobsForInstructor(
  ctx: QueryCtx,
...
const geoCore = {
  instructorGeo,
  jobGeo,
  findInstructorsForJobQuery,
  getNearbyJobsForInstructor,
  syncInstructorLocation,
  removeInstructorLocation,
  syncJobLocation,
  removeJobLocation,
  findInstructorsForJob,
